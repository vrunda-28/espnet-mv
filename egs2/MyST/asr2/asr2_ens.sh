...
kmeans_feature="[wavlm_large,hubert_large_ll60k,xls_r_300m]" # format: ssl_model_type/layer_idx (e.g. mfcc, hubert_large/21, wavlm_large/21)
...
# ASR model related
asr_tag=ensemble_wavlm_hubert_xlsr_21_km2000        # Suffix to the result dir for asr model training.
...
if [ ${kmeans_feature} = "mfcc" ]; then  # MFCC has no layer
    ...
    kmeans_feature_conf="{type=s3prl_ensemble,conf={s3prl_conf=${s3prl_conf},download_dir=ckpt,multilayer_feature=False,layer=${layer}}}"
fi
